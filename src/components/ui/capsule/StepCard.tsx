        ...
        <div className="flex items-center justify-center h-24">
          {isRevealCard ? (
            <div className="relative w-16 h-16 flex items-center justify-center">
              <Icon className="absolute top-0 left-0 w-10 h-10 text-blue-500 animate-sparkle" />
              <Icon className="absolute top-2 right-0 w-8 h-8 text-amber-500 animate-sparkle" style={{ animationDelay: "0.2s" }} />
              <Icon className="absolute bottom-0 left-2 w-9 h-9 text-emerald-500 animate-sparkle" style={{ animationDelay: "0.4s" }} />
            </div>
          ) : (
            <Icon className={cn(
              "w-16 h-16",

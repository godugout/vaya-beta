...
export const CapsuleHeader = () => {
  return (
    <div className="relative w-full bg-gradient-to-b from-vaya-primary/90 to-vaya-primary/70 pb-20 sm:pb-24 md:pb-28">
      <div className="relative z-10 max-w-7xl mx-auto text-center py-12 sm:py-14 md:py-16 px-4">

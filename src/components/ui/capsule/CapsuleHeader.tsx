...
export const CapsuleHeader = () => {
  return (
    <div className="relative w-full bg-gradient-to-b from-vaya-primary/90 to-vaya-primary/70 -mt-20 pb-48">
      <div className="relative z-10 max-w-7xl mx-auto text-center px-4 h-full flex items-center justify-center min-h-[24rem]">
        <div>

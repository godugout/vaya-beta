...
export const CapsuleHeader = () => {
  return (
    <div className="relative mx-auto py-32 md:py-40 lg:py-48 px-4 w-full left-0 -mt-20 bg-gradient-to-b from-vaya-primary/90 to-vaya-primary/70">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="max-w-2xl text-base md:text-xl mt-8 text-white/90 font-inter drop-shadow">

      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            >
              Vaya<sup className="opacity-75 transition-all duration-300 group-hover:text-autumn text-2xl sm:text-3xl font-semibold -ml-0.5">ᵈ</sup>
            </span>
          </Link>
        ...
        <div className="border-t border-vaya-gray-200 dark:border-dark-border pt-8">
          ...
          <div className="flex flex-wrap items-center justify-center sm:justify-between gap-x-8 gap-y-4">
            <div className="flex flex-wrap items-center gap-x-8 gap-y-4">
              <a href="#" className="text-lg sm:text-xl leading-7 text-vaya-gray-600 dark:text-dark-text-secondary hover:text-autumn dark:hover:text-dark-accent-purple hover:underline transition-colors">
                About Allusion Ink
              </a>
              <a href="#" className="text-lg sm:text-xl leading-7 text-vaya-gray-600 dark:text-dark-text-secondary hover:text-autumn dark:hover:text-dark-accent-purple hover:underline transition-colors">
                Contact

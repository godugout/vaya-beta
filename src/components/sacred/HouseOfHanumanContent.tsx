...
export const HouseOfHanumanContent = () => {
  ...
  const content = {
    ...
    gu: {
      ...
      closing: "આ વેબપેજ અને વાયા એપ્લિકેશન આ પરિવારની કથાઓને સંરક્ષિત કરવાનું માધ્યમ છે. ઇતિહાસ, સાંસ્કૃતિક પરંપરાઓ, અને વડીલોના અનુભવો એ અમૂલ્ય ખજાનો છે જે આવનારી પેઢીઓને માર્ગદર્શન આપશે."
    },
    hi: {

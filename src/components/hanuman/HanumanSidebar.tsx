...
const HanumanSidebar: React.FC<HanumanSidebarProps> = ({
  ...
  return (
    <div className="backdrop-blur-sm bg-gradient-to-br from-amber-900/20 via-amber-800/10 to-green-900/15 rounded-3xl shadow-[0_0_40px_rgba(255,126,0,0.15)] p-6 h-full overflow-hidden border-none relative">
      ...
      <div className="mt-6 p-4 rounded-xl bg-black/30 border border-hanuman-orange/10">
        <h3 className="text-sm font-medium text-hanuman-gold mb-2 flex items-center">
          <Star className="h-4 w-4 mr-1 text-hanuman-gold" />
          Hanuman Edition
        </h3>

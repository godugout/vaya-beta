...
const ShareStories = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-dark-background-orange/90 to-dark-background-red/80 dark:from-dark-background-orange dark:to-dark-background-red relative overflow-hidden">
      {/* Background pattern - adjusted opacity and z-index */}
      <div className="absolute inset-0 bg-pattern-lines opacity-15 z-0"></div>
      
      {/* Cosmic background effect - adjusted z-index */}
      <div className="absolute inset-0 z-0">
        <CanvasRevealEffect 
          colors={[[255, 118, 117], [108, 92, 231], [255, 160, 90]]} 
          dotSize={1.5}
          animationSpeed={1.5}
          opacities={[0.15, 0.15, 0.2, 0.2, 0.25, 0.25, 0.3, 0.3]}
        />
      </div>

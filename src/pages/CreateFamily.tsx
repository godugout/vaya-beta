  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="container max-w-4xl mx-auto py-12 px-4 relative z-10">
        <div className="backdrop-blur-sm bg-gradient-to-br from-purple-900/20 via-indigo-900/10 to-blue-900/15 rounded-3xl shadow-[0_0_40px_rgba(139,92,246,0.15)] p-8 overflow-hidden border-none">
          {/* Decorative cosmic elements */}
          <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-purple-500/10 blur-3xl rounded-full transform translate-x-1/3 -translate-y-1/3 pointer-events-none"></div>
          <div className="absolute bottom-0 left-0 w-1/3 h-1/3 bg-blue-500/10 blur-3xl rounded-full transform -translate-x-1/3 translate-y-1/3 pointer-events-none"></div>
          <div className="absolute -bottom-32 -right-32 w-64 h-64 bg-indigo-500/10 blur-3xl rounded-full pointer-events-none"></div>
          
          <h1 className="text-3xl font-bold text-center mb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-300 to-indigo-300 relative z-10">

  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="container max-w-4xl mx-auto py-12 px-4 relative z-10">
        <div className="backdrop-blur-sm bg-black/10 border border-white/10 rounded-xl p-8 shadow-xl overflow-hidden">
          {/* Decorative elements and gradients */}
          <div className="absolute inset-0 bg-gradient-to-br from-teal-900/20 via-blue-900/15 to-orange-800/15 pointer-events-none"></div>
